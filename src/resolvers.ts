...
const checkBishopMoveIsInvalid = (location: locationMove) => {
  ...
  //       for( i = 1; i<= rand; i++){
  //         chessBlacks.every(el => {
  //           if((bishop.x + i) == el.x && (bishop.y + i) == el.y){
  //             console.log('yes - 1 -' + el.name)
  //             isCheck = false;
  //             return false;
  //           }
  //           return true;
